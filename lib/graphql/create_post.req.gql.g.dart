...
class _$GCreatePostReq extends GCreatePostReq {
  ...
  factory _$GCreatePostReq([void Function(GCreatePostReqBuilder)? updates]) =>
      (new GCreatePostReqBuilder()..update(updates)).build();
  ...
  _$GCreatePostReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GCreatePostReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GCreatePostReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GCreatePostReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GCreatePostReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GCreatePostReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
